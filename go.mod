module github.com/thinkgos/proc-kit
...
require (
	...
	github.com/thinkgos/proc v0.0.0-20260910230056-3457c44b645e
	github.com/thinkgos/proc-extra v0.0.0-20260909135319-4420a271e071
